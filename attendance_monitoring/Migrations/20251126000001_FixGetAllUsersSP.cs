...
{
    /// <inheritdoc />
    public partial class FixGetAllUsersSP : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop the existing stored procedure with incorrect table names
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_GetAllUsers");

            // Recreate with correct ASP.NET Identity table names
